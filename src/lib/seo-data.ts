...
export const whyItems = [
  ...
  {
    icon: "local_hospital",
    title: "Tela médica certificada",
    desc: "Usamos Sincatex anti-fluidos y Lino Oxford. Las mismas telas que usan hospitales y clínicas líderes, a precio accesible.",
  },
];
...
export const socialLinks = [
  ...
  {
    red: "YouTube",
    url: "https://www.youtube.com/@confeccionliss",
    icon: "play_circle",
  },
  {
    red: "Google Maps",
