...
const SCRUBS_PRODUCTS: Product[] = [
  {
    ...
    tipo: "scrubs",
    sector: "scrubs",
    imagen: "/images/productos/scrub-san-miguel.png",
  ...
  },
  {
    ...
    tipo: "scrubs",
    sector: "scrubs",
    imagen: "/images/productos/scrub-sincatex-clasico.png",
    tallas: ["S", "M", "L", "XL"],
    showBadge: false,
  },
  {
    ...
    tipo: "gorros",
    sector: "scrubs",
    imagen: "/images/productos/gorro-quirurgico-premium.png",
    tallas: [],
    showBadge: false,
  },
  {
    ...
    tipo: "batas",
    sector: "scrubs",
    imagen: "/images/productos/bata-medica-clasica.png",
    tallas: ["S", "M", "L", "XL"],
    showBadge: false,
  },
  {
    ...
    tipo: "scrubs",
    sector: "scrubs",
    imagen: "/images/productos/scrub-premium-verde.png",
    tallas: ["XS", "S", "M", "L", "XL"],
    showBadge: true,
    badgeText: "Popular",
  },
  {
    ...
    tipo: "chaquetas",
    sector: "scrubs",
    imagen: "/images/productos/chaqueta-clinica.png",
    tallas: ["M", "L", "XL"],
    showBadge: false,
  },
];
