    ...
    <div className="mx-auto flex min-h-[calc(100dvh-56px)] w-full max-w-screen-2xl flex-1 flex-col px-5 py-[var(--space-lg)] md:px-8">
      ...
      <div className="grid grid-cols-1 items-start gap-10 lg:grid-cols-[45%_1fr] lg:gap-12">
        ...
        >
          ...
          ──────────────────────────────────────────────────────────────── */}
          <div className="grid grid-cols-1 items-start gap-6 md:grid-cols-[40%_60%] lg:grid-cols-1">
            {/* ── Columna izquierda ── */}
              ...
              >
                  ...
                  {isALaMedida ? (
                    <li className="flex items-start gap-2 text-sm text-slate-600">
                      ...
                      <span>
                        ...
                        a la medida tienen el mismo precio que las tallas
                        estándar y se cobran según la equivalencia de tus
                        medidas; por ejemplo, si estas corresponden a una talla
                        M, se aplicará el precio de la talla M.
                      </span>
                    </li>
                  ) : (
                    <div className="flex items-end gap-3">
                      {selectedSizeBasePrice !== null ? (
                        ...
                        <p className="text-primary text-3xl leading-none font-extrabold tracking-tight">
                          Desde $
                          {(globalMinOfferPrice ?? globalMinBasePrice).toFixed(
                            2
                          )}
                        </p>
                      ) : (
                ...
                <div className="flex gap-3">
                  <button
                    ...
                    className="bg-primary hover:bg-primary/90 flex flex-1 cursor-pointer items-center justify-center gap-2 rounded-xl py-3.5 font-bold text-white shadow-md transition hover:shadow-lg active:scale-[0.97] md:py-2.5 lg:py-3.5"
                  >
                  ...
                  <button
                    ...
                    className="border-primary text-primary hover:bg-primary/5 flex flex-1 cursor-pointer items-center justify-center gap-2 rounded-xl border-2 bg-white py-3.5 font-bold transition active:scale-[0.97] md:py-2.5 lg:py-3.5"
