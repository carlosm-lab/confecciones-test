    ...
    >
      <Section n={1} title="Aceptación de los términos">
        <P>
          ...
          aceptado en su totalidad los presentes Términos y Condiciones de Uso.
          Esta aceptación es inmediata y automática desde el momento en que
          accede a cualquier página de la plataforma, independientemente de si
          ha creado una cuenta o si navega como visitante anónimo.
        </P>
        <P>
      ...
      >
        <P>
          ...
          de prendas en línea cuyo propósito es exhibir productos disponibles y
          facilitar el contacto entre compradores y la administración del
          negocio. La plataforma no procesa pagos, no gestiona inventario en
          tiempo real, no garantiza disponibilidad inmediata de ningún producto,
          y no constituye por sí misma un contrato de compraventa.
        </P>
        <P>
        ...
        <P>
          El operador se reserva el derecho de modificar, suspender, interrumpir
          o discontinuar el servicio en cualquier momento, sin que esto genere
          obligación de compensación o responsabilidad hacia los usuarios.
        </P>
      </Section>
      <Hr />
      ...
      <Section n={3} title="Elegibilidad y capacidad legal">
        <P>
          Para utilizar los servicios de esta plataforma usted declara tener al
          menos dieciocho años de edad o la mayoría de edad legal en su
        ...
        <P>
          ...
          ella. No está permitido crear cuentas ficticias ni utilizar mecanismos
          automatizados para crear múltiples cuentas.
        </P>
      </Section>
      <Hr />
      ...
      >
        ...
        <P>
          ...
          asumir que la adquisición es posible. Ninguna de estas circunstancias
          genera derecho a reclamación alguna contra el operador.
        </P>
      </Section>
      <Hr />
      ...
      <Section n={5} title="Pagos y modalidades de pago">
        <P>
          Esta plataforma no procesa pagos de ningún tipo. No existe integración
          con pasarelas de pago, sistemas de tarjetas de crédito o débito,
          billeteras digitales ni ningún otro mecanismo de pago automatizado. La
          plataforma no almacena, no solicita y no transmite información
          financiera de ninguna naturaleza.
        </P>
        <P>
      ...
      <Section n={6} title="Cuentas de usuario y responsabilidades del titular">
        <P>
          Al crear una cuenta mediante Google OAuth, el usuario se convierte en
          el único responsable de toda la actividad realizada bajo su cuenta,
          incluyendo todas las comunicaciones enviadas a través del formulario
          de contacto y cualquier otra interacción con el sistema. Se compromete
          a notificar inmediatamente a la administración si sospecha que su
          cuenta ha sido accedida por un tercero no autorizado.
        </P>
        <P>
          ...
          resultar en la suspensión de la cuenta sin previo aviso y sin derecho
          a compensación.
        </P>
      </Section>
      <Hr />
      ...
      <Section n={8} title="Propiedad intelectual y contenido de la plataforma">
        <P>
          Todo el contenido de la plataforma — textos, fotografías de productos,
          logotipos, diseños, código fuente, estructura de navegación y
          cualquier otro elemento protegible — es propiedad del operador o ha
          sido licenciado por sus legítimos titulares. Ningún elemento puede ser
          copiado, reproducido, distribuido, publicado o utilizado de ninguna
          manera sin el consentimiento previo y expreso por escrito del
          operador.
        </P>
        <P>
          El usuario obtiene únicamente una licencia limitada, personal, no
          exclusiva, no transferible y revocable para visualizar el contenido de
          la plataforma con el único propósito de explorar el catálogo y generar
          pedidos según el flujo normal de uso previsto. Esta licencia no
          incluye ningún derecho a descargar, redistribuir ni comercializar el
          contenido.
        </P>
      </Section>
      <Hr />
      ...
      >
        <P>
          El operador realiza sus mejores esfuerzos para mantener la información
          del catálogo actualizada y precisa, pero no garantiza la exactitud,
          completitud o idoneidad de la información presentada. Las fotografías
          de los productos son representativas y pueden diferir del producto
          real en aspectos como el color, dimensiones o acabado. Las
          descripciones son meramente informativas y no constituyen
          especificaciones técnicas garantizadas.
        </P>
        <P>
          El usuario asume la plena responsabilidad de verificar las
          características del producto directamente con la administración antes
          de proceder con cualquier adquisición.
        </P>
      </Section>
      <Hr />
      ...
      >
        <P>
          ...
          técnicos o interrupciones del servicio; transacciones realizadas entre
          el comprador y el negocio fuera de la plataforma; o conducta de otros
          usuarios de la plataforma.
        </P>
      </Section>
      <Hr />

      <Section n={11} title="Exoneración de responsabilidad del desarrollador">
        <P>
          ...
          comerciales del negocio, en la determinación de precios, en la gestión
          del inventario, ni en ningún otro aspecto operativo de Confecciones
          Liss. El usuario reconoce que el desarrollador es un tercero ajeno a
          cualquier relación comercial entre el usuario y el negocio, y renuncia
      ...
      >
        <P>
          La plataforma utiliza servicios de terceros: <strong>Supabase</strong>{" "}
          (base de datos y autenticación), <strong>Vercel</strong> (alojamiento
          y distribución de contenido), <strong>Google</strong> (autenticación
          OAuth), y <strong>Meta Platforms/WhatsApp</strong> (comunicación entre
          usuario y negocio). El operador no tiene control sobre estos servicios
          y no asume responsabilidad por sus interrupciones, cambios de política
          o cualquier otro aspecto de su operación.
        </P>
      </Section>
      <Hr />
      ...
      <Section n={13} title="Indemnización por parte del usuario">
        <P>
          ...
          reclamación, pérdida, costo o gasto que resulte del incumplimiento de
          estos términos, el uso indebido de la plataforma, la violación de
      ...
      <Section n={14} title="Modificaciones a los términos y condiciones">
        <P>
          ...
          reemplazar los presentes términos en cualquier momento y sin necesidad
          de notificación previa individual. Las modificaciones entrarán en
          vigencia inmediatamente después de su publicación. El uso continuado
          de la plataforma después de cualquier modificación constituirá
          aceptación automática de los nuevos términos.
        </P>
      </Section>
      <Hr />
      ...
      <Section n={15} title="Suspensión y terminación del servicio">
        <P>
          El operador se reserva el derecho de suspender o terminar el acceso de
          cualquier usuario a la plataforma, con o sin previo aviso, por
          cualquier razón que considere suficiente, incluyendo el incumplimiento
          de estos términos. La suspensión o terminación no genera derecho a
          compensación o indemnización de ningún tipo.
        </P>
        <P>
          El operador también puede discontinuar permanentemente la operación de
          la plataforma en cualquier momento sin que esto genere obligación de
          compensación. Los usuarios no tienen ningún derecho adquirido sobre la
      ...
      <Section n={17} title="Divisibilidad y acuerdo completo">
        <P>
          ...
          continuarán en plena vigencia y efecto. Estos términos constituyen el
          acuerdo completo entre el usuario y el operador con respecto al uso de
          la plataforma y sustituyen a cualquier acuerdo anterior sobre el mismo
          objeto.
        </P>
      </Section>
