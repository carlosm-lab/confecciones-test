  ...
  return (
    ...
    >
      ...
      <div className="relative aspect-[32/15] max-h-[150px] w-full overflow-hidden bg-gray-50 sm:max-h-none">
        ...
        <div className="pointer-events-none absolute top-0 right-0 z-10 h-14 w-36 bg-gradient-to-bl from-white/85 via-white/25 to-transparent" />

        {/* Floating Action Link (Text Only) */}
        <div className="text-primary group-hover:text-tertiary contrast-text-shadow absolute top-3 right-3 z-20 flex items-center gap-1 text-[8px] font-bold tracking-wider uppercase transition-colors @[280px]:text-[9px] @[360px]:text-[10px]">
