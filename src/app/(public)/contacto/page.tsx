...
const PAGE_DESCRIPTION =
  "Estamos listos para ayudarte con tu pedido. Escríbenos al WhatsApp 7331-7181, llámanos hoy o visítanos en nuestro taller en Barrio La Merced, San Miguel.";
    ...
    <>
      ...
      <main className="relative overflow-hidden px-5 pb-20 md:px-8">
        ...
        <div className="relative mx-auto max-w-screen-2xl">
          ...
          <section
            className="animate-fade-in-up group border-primary/35 hover:border-primary/55 mt-10 overflow-hidden rounded-2xl border bg-white shadow-[0_0_25px_6px_rgba(20,48,103,0.15),0_0_10px_2px_rgba(20,48,103,0.1)] transition-all duration-300 hover:shadow-[0_0_45px_15px_rgba(20,48,103,0.26),0_0_20px_5px_rgba(20,48,103,0.16)]"
            style={{ animationDelay: "550ms" }}
          >
            <div className="grid lg:grid-cols-[2fr_3fr]">
              {/* Left panel — info contextual */}
              <div className="bg-primary relative flex flex-col justify-between gap-6 overflow-hidden p-8 md:p-10">
                {/* Decorative circles */}
                <div
                  className="pointer-events-none absolute -top-12 -right-12 h-48 w-48 rounded-full bg-white/5"
                  aria-hidden="true"
                />
                <div
                ...
                <div className="relative">
                  ...
                  <p className="text-sm leading-relaxed text-white/75">
                    Cuéntanos sobre tu pedido, material, tallas y cantidad.
                ...
                <div className="relative space-y-4">
                  {[
                    ...
                    {
                      icon: "verified",
                      text: "Cotizaciones sin compromiso",
                    },
                    {
                      icon: "lock",
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="relative inline-flex items-center gap-2 rounded-xl bg-white/10 px-4 py-2.5 text-sm font-semibold text-white transition hover:bg-white/20 active:scale-[0.97]"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 24 24"
