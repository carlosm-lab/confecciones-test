...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const staticPages: MetadataRoute.Sitemap = [
    ...
    {
      url: `${siteConfig.url}/empresa/sobre-nosotros`,
      lastModified: new Date("2026-06-24"),
      changeFrequency: "monthly",
      priority: 0.75,
    },
    {
      url: `${siteConfig.url}/empresa/filosofia`,
      lastModified: new Date("2026-06-24"),
      changeFrequency: "monthly",
      priority: 0.7,
    },
    {
      url: `${siteConfig.url}/empresa/equipo`,
      lastModified: now,
      changeFrequency: "weekly",
      priority: 0.75,
    },
    {
      url: `${siteConfig.url}/empresa/proceso-de-confeccion`,
      lastModified: now,
      changeFrequency: "weekly",
      priority: 0.75,
    },
    {
      url: `${siteConfig.url}/empresa/calidad`,
      lastModified: now,
      changeFrequency: "weekly",
      priority: 0.75,
    },
    {
      url: `${siteConfig.url}/empresa/certificaciones`,
      lastModified: now,
      changeFrequency: "weekly",
      priority: 0.75,
    },
    {
      url: `${siteConfig.url}/empresa/responsabilidad-social`,
      lastModified: now,
      changeFrequency: "weekly",
      priority: 0.75,
    },
    {
      url: `${siteConfig.url}/empresa/transparencia`,
      lastModified: now,
      changeFrequency: "weekly",
      priority: 0.75,
    },
    {
      url: `${siteConfig.url}/empresa/media-kit`,
      lastModified: new Date("2026-06-24"),
      changeFrequency: "monthly",
      priority: 0.6,
    },
